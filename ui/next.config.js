...
const nextConfig = {
   ...
   */
  basePath: isProd ? '/Mina-ERC721': '', // update if your repo name changes for npm run deploy to work successfully
  assetPrefix: isProd ? '/Mina-ERC721': '', // update if your repo name changes for npm run deploy to work successfully
